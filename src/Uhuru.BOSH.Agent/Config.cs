    ...
    public static class Config
    {
        ...
        public static void Setup(dynamic config, bool firstDeployment)
        {
            ...
            if (!Config.Configure)
            {
                ...
                Config.BlobstoreOptions = config["blobstore"]["options"] != null ? config["blobstore"]["options"] : null;
            }
            else
            {
            ...
            Config.BlobstoreProvider = config["blobstore"] != null ? config["blobstore"]["provider"].Value : null;
