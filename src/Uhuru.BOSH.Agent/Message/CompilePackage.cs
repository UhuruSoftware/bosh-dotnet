...
namespace Uhuru.BOSH.Agent.Message
{
    ...
    public class CompilePackage : IMessage
    {
        ...
        public string Process(dynamic args)
        {
            ...
            this.sourceFile = Path.Combine(Config.BaseDir, "data", "tmp", blobStoreId);
        ...
        {
            this.logger.Info("Compiling package, copying files to install directory");
        ...
        private CompileResult.UploadResult Upload()
        {
            ...
            CompileResult.UploadResult compileResult = new CompileResult.UploadResult();
